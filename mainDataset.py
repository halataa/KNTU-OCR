...
with open("D:\\UNIVERSITY\\BACHELOR PROJECT\\Data\\nastaliq.txt", 'rb') as moinFile:
    nastaliqList=pickle.load(moinFile)
...
while len(moin)>0:
    ...
    if 500<image.size[0]<720:
        ...
        image.save("D:\\UNIVERSITY\\BACHELOR PROJECT\\Data\\mainDataset\\kntu%s.png" %imageNumber)
